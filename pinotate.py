...
if __name__ == "__main__":
    ...
    ap.add_argument('--headings', default=True, action="store_true", help='add headings to markdown')
    ap.add_argument('-s', '--sort', default=True, action="store_true", help='sort by location instead of time')
